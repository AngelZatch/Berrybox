...
$lang["welcome_admin"] = "あなたのボックスへようこそ！ビデオ曲を提出ために、YouTubeのリンクをプレイヤーの下に貼り付けます。あなたはこのボックスに運営者です。もし、あなたがこのボックスを閉じままにしないように出ます、ビデオシンクロとプレイがストップします。";
$lang["invalid_macro"] = "入力したコマンドは無効です。";
$lang["no_power"] = "このコマンドを使用する権限を持っていません";
...
$lang["profile_history_tip"] = "もし、最後の１時間で誰かがメッセージ送信しませんとかビデオが始まりません、ボックスが無効にされています。そして24時間以内に削除されます。";
...
$lang["maintenance"] = "ベリボックスは<strong>2016年11月15日〔火〕17:00より18:00頃まで</strong>メンテナンス作業を実施いたします。メンテナンス作業中、ベリボックスをご利用いただくことができません。メンテナンスの後、全ボックスは削除されます。お客様にはご迷惑をおかけいたしますが、ご了承くださいますようお願いいたします。";
