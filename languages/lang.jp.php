...
$lang["open_room"] = "ルームを再開します";
$lang["open_room_tip"] = "ビデオ提出やプレイが再活性化にされます。";
...
$lang["welcome_admin"] = "あなたのボックスへようこそ！ビデオ曲を提出ために、YouTubeのリンクをプレイヤーの下に貼り付けます。あなたはこのボックスにアドミニストレータです。もし、あなたがこのボックスを閉じままにしないように出ます、ビデオシンクロとプレイがストップします。";
