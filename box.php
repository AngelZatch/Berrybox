...
<html>
	...
	<body>
		<div class="col-md-8 col-lg-9" id="room-player">
			<div class="container-fluid room-info">
				<div class="col-xs-3 col-sm-2 col-md-1 top-box-picture">
				...
				<div class="col-xs-9 col-sm-10 col-md-11 top-box-infos">
					<div class="row">
						<p class="col-xs-10" id="room-title"><?php echo $roomDetails["room_name"];?></p>
					</div>
					<div class="row">
						<p class="col-xs-8" id="room-undertitle"> <a href="user/<?php echo $roomDetails["user_pseudo"];?>" target="_blank"><?php echo $roomDetails["user_pseudo"];?></a> | <span class="glyphicon glyphicon-play" title="<?php echo $lang["now_playing"];?>"></span> <span class="currently-name"></span></p>
						<div class="creator-stats col-xs-4">
							<?php
							if(isset($_SESSION["token"]) && $_SESSION["token"] != $roomDetails["room_creator"]){
								if($userFollow == 1) {
							?>
							<button class="btn btn-primary btn-active btn-toggle-follow btn-unfollow" id="box-title-unfollow" value="<?php echo $roomDetails["user_pseudo"];?>"><span class="glyphicon glyphicon-heart"></span> <?php echo $lang['following']." ".$roomDetails["user_pseudo"];?></button>
							<?php
								} else {
							?>
							<button class="btn btn-primary btn-toggle-follow btn-follow" id="box-title-follow" value="<?php echo $roomDetails["user_pseudo"];?>"><span class="glyphicon glyphicon-heart"></span> <?php echo $lang['follow']." ".$roomDetails["user_pseudo"];?></button>
							<?php
								}
							}
							?>
			...
			<div class="container-fluid under-video">
				...
				<div class="add-link col-sm-3 col-xs-4">
					<?php } else { ?>
					<div class="add-link col-sm-4 col-xs-6">
						<?php } ?>
						<div class="input-group">
							<input type="text" placeholder="<?php echo $lang["youtube_message"];?>" class="form-control url-box">
							<span class="input-group-btn">
								<button class="btn btn-primary play-url"><span class="glyphicon glyphicon-circle-arrow-right"></span> <?php echo $lang["submit_link"];?></button>
							</span>
						</div>
					...
					<?php } ?>
					<?php if(isset($_SESSION["token"]) && $_SESSION["token"] == $roomDetails["room_creator"]){?>
					<div class="room-buttons col-xs-2 col-sm-1">
					...
					<?php } ?>
					<div class="room-quick-messages col-xs-3">
			...
			<div class="col-md-4 col-lg-3" id="room-chat">
