	...
	<body>
		<div class="col-sm-8 col-lg-9" id="room-player">
			...
			<div class="container-fluid under-video">
				...
				<div class="add-link col-xs-6 col-sm-3">
					<?php } else { ?>
					...
					<?php } ?>
					<?php if(isset($_SESSION["token"]) && $_SESSION["token"] == $roomDetails["room_creator"]){?>
					<div class="room-buttons col-xs-3 col-sm-1 col-md-1 col-lg-1">
						<button class="btn btn-default btn-admin btn-skip"><span class="glyphicon glyphicon-step-forward resize-lg"></span> <span class="hidden-xs hidden-sm hidden-md"><?php echo $lang["skip"];?></span></button>
					</div>
					<?php } ?>
