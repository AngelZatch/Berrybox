		...
		<div class="main">
			<div id="create-room-form">
				<div class="form-group">
					<label for="roomName"><?php echo $lang["room_name"];?></label>
					<input type="text" placeholder="<?php echo $lang["room_name"];?>" class="form-control" name="roomName">
				</div>
				<div class="form-group">
					<div class="radio"><label for=""><input type="radio" name="protection"><?php echo $lang["level_private"];?></label></div>
					<div class="radio"><label for=""><input type="radio" name="protection"><?php echo $lang["level_locked"];?></label></div>
					<div class="radio"><label for=""><input type="radio" name="protection"><?php echo $lang["level_public"];?></label></div>
				</div>
